...
const HeroSection = ({ onApply, stats = { applicants: 2400, earlyUsers: 580, countries: 12 } }: HeroProps) => {
  return (
    <section className="relative min-h-[90dvh] flex flex-col items-center justify-center px-5 sm:px-6 text-center overflow-hidden pt-28 sm:pt-36">
      ...
      {/* Store badges */}
      <div className="mt-4 sm:mt-5 flex flex-col items-center gap-3 opacity-0 animate-fade-up-delay-3">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-border/40 bg-muted/5 hover:bg-muted/10 transition-colors cursor-default">
