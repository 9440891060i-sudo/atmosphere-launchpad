        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 px-5 py-2.5 rounded-lg border border-border/40 bg-muted/5 hover:bg-muted/10 transition-colors cursor-default">
            ...
            <div className="flex flex-col">
              <span className="text-muted-foreground text-[9px] font-light leading-none">Download on the</span>
              <span className="text-foreground text-sm font-medium leading-tight">App Store</span>
            </div>
          </div>
          {/* Google Play Badge */}
          <div className="flex items-center gap-2 px-5 py-2.5 rounded-lg border border-border/40 bg-muted/5 hover:bg-muted/10 transition-colors cursor-default">
            ...
            <div className="flex flex-col">
              <span className="text-muted-foreground text-[9px] font-light leading-none">GET IT ON</span>
              <span className="text-foreground text-sm font-medium leading-tight">Google Play</span>
            </div>
          </div>
        </div>
        <span className="text-muted-foreground/50 text-xs font-light tracking-[0.2em] uppercase">Launching Soon</span>
      </div>
    </section>);
